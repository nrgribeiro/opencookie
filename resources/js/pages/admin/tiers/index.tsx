...
import {
    destroy as tierDestroy,
    index as tiersIndex,
    store as tierStore,
    update as tierUpdate,
} from '@/routes/admin/tiers';
                ...
                <form onSubmit={submit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2 space-y-2">
                            <Label htmlFor="monthly_pageview_cap">
                                Monthly pageview cap (blank = ∞)
                            </Label>
                            <Input
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="scheduled_scans_allowed">
                            Scheduled scans allowed
                        </Label>
                    </div>
                    <div className="flex items-center gap-2">
                        <Checkbox
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <div className="flex items-center justify-between">
                    <Heading
                        title="Tiers"
                        description="Account limits applied to users."
                    />
                                ...
                                {tiers.map((t) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 pr-4">
                                            {unlimited(t.maxDomains)}
                                        </td>
                                        <td className="py-2 pr-4">
                                            {t.maxScanPages.toLocaleString()}
                                        </td>
                                        <td className="py-2 pr-4">
                                            {unlimited(t.monthlyPageviewCap)}
                                        </td>
                                        <td className="py-2 pr-4">
                                            {t.scheduledScansAllowed
                                                ? 'Yes'
                                                : 'No'}
                                        </td>
