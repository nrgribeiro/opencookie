        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <Heading
                    ...
                    description="Usage, tiers, and compliance across all accounts."
                />
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Stat
                        label="Compliant domains"
                        value={stats.compliantDomains}
                    />
                    <Stat
                        label="Non-compliant domains"
                        value={stats.nonCompliantDomains}
                    />
                    <Stat label="Scans run" value={stats.scans} />
                    <Stat
                        label="Consent records"
                        value={stats.consentRecords}
                    />
                </div>
                    ...
                    <CardContent>
                        {nonCompliant.length === 0 ? (
                            <p className="text-sm text-muted-foreground">
                                Every domain is fully compliant. 🎉
                            </p>
                        ) : (
