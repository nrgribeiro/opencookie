...
export default function BannerBuilder({
    ...
    const publish = () => {
        ...
        save(() =>
            router.post(
                BannerController.publish(domain.id).url,
                {},
                { preserveScroll: true },
            ),
        );
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <div className="flex items-center justify-between">
                    <Heading
                        ...
                        description={`Draft v${config.version}`}
                    />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="mt-3 text-xs text-muted-foreground">
                                    Reject and Accept render with equal
                                    prominence (GDPR — freely given consent).
                                </p>
                            </CardContent>
                        </Card>
